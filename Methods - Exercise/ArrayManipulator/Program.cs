        ...
        static void Main(string[] args)
        {
            ...
            while ((command = Console.ReadLine()) != "end")
            {
                ...
                else if (cmdType == "max" || cmdType == "min")
                {
                    ...
                    if (cmdType == "max")
                    {
                        indexOfElement = IndexOfMaxEvenOrOddElement(arr, evenOrOddArg);
                    }
                    else
                    {
                      indexOfElement = IndexOfMinEvenOrOddElement(arr, evenOrOddArg);
                    }
                ...
                else if (cmdType == "first" || cmdType == "last")
                {
                    ...
                    if (cmdType == "first")
                    {
                        element = FirstEvenOrOddElements(arr,count, evenOrOddArg);
                    }
                    else
                    {
                        element = FirstEvenOrOddElements(arr,count, evenOrOddArg);
